            ...
            <transition :name="routerTransition">
              ...
              <div
                ...
                <div
                  ...
                  :class="{'pr-4 border-0 md:border-r border-solid border-grey-light'
                ...
                <!-- BREADCRUMB -->
                <vx-breadcrumb
                  class="ml-4 md:block hidden" v-if="$route.meta.breadcrumb"
                    ...
                    <vs-dropdown-item>
                      <div @click="$router.push('/pages/profile').catch(() => {})"
                        ...
                        <feather-icon icon="UserIcon"
                                      class="inline-block mr-2" svgClasses="w-4 h-4" />
                        <span>Profile</span>
                      </div>
                    </vs-dropdown-item>
                    <vs-dropdown-item>
            ...
            <div class="content-area__content">
              ...
              <back-to-top bottom="5%"
                ...
                <vs-button icon-pack="feather"
                           icon="icon-arrow-up" class="shadow-lg btn-back-to-top" />
              </back-to-top>
...
import HNavMenu from '@/layouts/components/horizontal-nav-menu/HorizontalNavMenu';
// import navMenuItems        from "@/layouts/components/vertical-nav-menu/navMenuItems.js"
import TheNavbarHorizontal from '@/layouts/components/navbar/TheNavbarHorizontal';
import TheNavbarVertical from '@/layouts/components/navbar/TheNavbarVertical';
import TheFooter from '@/layouts/components/TheFooter';
import themeConfig from '@/../themeConfig';
import VNavMenu from '@/layouts/components/vertical-nav-menu/VerticalNavMenu';
