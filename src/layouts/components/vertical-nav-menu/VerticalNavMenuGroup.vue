...
=========================================================================================
  ...
  Description: Vertical NavMenu Group Component.
    Extends vuesax framework's 'vs-sidebar-group' component
  ...
  computed: {
    ...
    isGroupActive() {
      return (item) => {
        ...
        const func = (currentItem) => {
          if (currentItem.submenu) {
            currentItem.submenu.forEach((subMenuItem) => {
              if ((path === subMenuItem.url || routeParent === subMenuItem.slug) && item.url) {
                open = true;
