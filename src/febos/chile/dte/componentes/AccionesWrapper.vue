...
export default {
  ...
  computed: {
    mostrarModal: {
      ...
      set() {
        if (modalStore.state.showModal) { modalStore.commit('ocultarBitacora'); } else { modalStore.commit('mostrarBitacora'); }
      }
    },
    mostrarModalFull: {
      get() {
      ...
      set() {
        if (modalStore.state.showModalFull) { modalStore.commit('ocultarBitacoraFull'); } else { modalStore.commit('mostrarBitacoraFull'); }
      }
    },
    getTitulo: {
